...
public class UsuariosResource {
    ...
    public Response addUsuarios(
        ...
        if (uId != 1) {
            if (answ) {
                return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/usuarios_h.jsp?in=1")).build();
            } else {
                return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/usuarios_h.jsp?in=0")).build();
            }
        } else {
            if (answ) {
                return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/usuarios_h.jsp?up=1")).build();
            } else {
                return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/usuarios_h.jsp?up=0")).build();
            }
        }
    }
    ...
    public Response deleteUsuario(
        ...
        answ = delUsuario(uId);
        if (answ) {
            return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/usuarios_h.jsp?del=1")).build();
        } else {
            return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/usuarios_h.jsp?del=0")).build();
        }
    }
    ...
    public Response readdUsuario(
        ...
        if (answ) {
            return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/usuarios_h.jsp?readd=1")).build();
        } else {
            return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/usuarios_h.jsp?readd=0")).build();
        }
    }
