...
public class PatientResource {
    ...
    public Response addPatient(
        ...
        if (answ) {
            //return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/pacientes_h.jsp?in=1")).build();
            return Response.status(200).type(MediaType.APPLICATION_JSON).entity("{\"in\":1}").build();
        } else {
            //return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/pacientes_h.jsp?in=0")).build();
    ...
    public Response deletePatient(
        ...
        answ = delPatient(pId);
        if (answ) {
            //return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/pacientes_h.jsp?del=1")).build();
            return Response.status(200).type(MediaType.APPLICATION_JSON).entity("{\"del\":1}").build();
        } else {
            //return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/pacientes_h.jsp?del=0")).build();
    ...
    public Response updatePatient(
        ...
        if (answ) {
            ...
            //return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/pacientes_h.jsp?up=1")).build();
            ...
            //return Response.temporaryRedirect(URI.create("http://localhost/proyectoDB2-Hospital1/pacientes_h.jsp?up=0")).build();
