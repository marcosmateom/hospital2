...
public class DeleteCita extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Send data
            URL url = new URL("http://localhost/proyectoDB2-Hospital1/restC/cita/deleteCita");
            ...
            if (answ == 1) {
                response.sendRedirect("http://localhost/proyectoDB2-Hospital1/citas_h.jsp?del=1");
            } else {
                response.sendRedirect("http://localhost/proyectoDB2-Hospital1/citas_h.jsp?del=0");
            }
