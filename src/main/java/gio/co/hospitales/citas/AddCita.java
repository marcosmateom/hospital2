...
public class AddCita extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Send data
            URL url = new URL("http://localhost/proyectoDB2-Hospital1/restC/cita/addCita");
            ...
            if (answ == 1) {
                response.sendRedirect("http://localhost/proyectoDB2-Hospital1/citas_h.jsp?in=1");
            } else {
                response.sendRedirect("http://localhost/proyectoDB2-Hospital1/citas_h.jsp?in=0");
            }
            wr.close();
            rd.close();
        } catch (Exception e) {
            response.sendRedirect("http://localhost/proyectoDB2-Hospital1/citas_h.jsp?err=1");
