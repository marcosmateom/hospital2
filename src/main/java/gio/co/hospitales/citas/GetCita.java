    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (((parPId != null) && !(parPId.equals("")))) {
                ...
                url = "http://localhost/proyectoDB2-Hospital1/restC/cita/getCita?pId=" + pId;
            } else if (((parCitaId != null) && !(parCitaId.equals("")))) {
                int citaId = Integer.parseInt(parCitaId);
                url = "http://localhost/proyectoDB2-Hospital1/restC/cita/getCita?citaId=" + citaId;
            }else if (((pardocId != null) && !(pardocId.equals("")))) {
                int docId = Integer.parseInt(pardocId);
                url = "http://localhost/proyectoDB2-Hospital1/restC/cita/getCita?docId=" + docId;
            } else {
                url = "http://localhost/proyectoDB2-Hospital1/restC/cita/getCita";
            }
            URL obj = new URL(url);
