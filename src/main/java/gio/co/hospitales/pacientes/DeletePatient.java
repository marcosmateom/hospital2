...
public class DeletePatient extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Send data
            URL url = new URL("http://localhost/proyectoDB2-Hospital1/restP/patient/deletePatient");
            ...
            if (answ == 1) {
                response.sendRedirect("http://localhost/proyectoDB2-Hospital1/pacientes_h.jsp?del=1");
            } else {
                response.sendRedirect("http://localhost/proyectoDB2-Hospital1/pacientes_h.jsp?del=0");
            }
            wr.close();
            rd.close();
        } catch (Exception e) {
