...
public class Scheduler implements ServletContextListener {
    ...
    public int mongoInsert(String fechaCita, String doctor, String diagnostico, String resultados, String medicinas, String pasos, String observaciones, String dpi, String categoria, String subcat, int idCita, String pName, String pLastName){
        ...
        try {//b
            // Send data
            String rStmt ="http://localhost/proyectoDB2-seguro/restHist/hist/addHist?hospital="+hospitalNum+"&fecha="+fechaCita+"&doctor="+doctor+"&diagnostico="+diagnostico+"&resultados="+resultados+"&medicinas="+medicinas+"&pasos="+pasos+"&observaciones="+observaciones+"&dpi="+dpi+"&categoria="+categoria+"&subcat="+subcat+"&idCita="+idCita+"&nCliete="+pName+"&aCliente="+pLastName;
            //String rStmt = "http://localhost/proyectoDB2-seguro/restHist/hist/addHist?hospital=" + hospitalNum + "&fecha=" + fechaCita + "&doctor=" + doctor + "&diagnostico=" + diagnostico 
