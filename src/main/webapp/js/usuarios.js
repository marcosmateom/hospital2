                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        $pData.append("<tr><td>"+data[i].id+"</td>"+"<td>"+data[i].username+"</td>"
                                ...
                                "\" class=\"button pLink expanded\">Modificar</a><a href=\"http://localhost/proyectoDB2-Hospital1/deleteUser_h.jsp?uId="+data[i].id+
                        ...
                        $pData.append("<tr><td>"+data[i].id+"</td>"+"<td>"+data[i].username+"</td>"
                                ...
                                "</td>"+"<td>"+data[i].usSpecial+"</td><td>"+data[i].phone+"</td><td>"+data[i].state+
                                "</td><td><a href=\"adminUsers_h.jsp?uId="+data[i].id+
                                "\" class=\"button pLink expanded\">Modificar</a><a href=\"http://localhost/proyectoDB2-Hospital1/habilitarU_h.jsp?uId="+data[i].id+
