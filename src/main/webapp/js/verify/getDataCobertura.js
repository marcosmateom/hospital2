function getServicio(variable2)
{
   $.ajax({
        type: 'GET',
        url: 'http://localhost/proyectoDB2-Hospital1/getServicios',
        dataType: 'json',
...
function checkCobertura(){
        ...
        type: 'GET',
        url:'http://localhost/proyectoDB2-Hospital1/restP/patient/getPatient',
        dataType: 'json',
        data: {
        ...
        success: function(data) {
            ...
            $.ajax({
                type: 'GET',
                url:'http://localhost/proyectoDB2-Hospital1/GetCliente',
                dataType: 'json',
                data: {
                    dpi: data[0].dpi 
                },
            ...
            $.ajax({
                type: 'GET',
                url:'http://localhost/proyectoDB2-Hospital1/verifyCobertura',                      //Verificar si el seguro si cubre el servicio
                dataType: 'json',
                data: {
                    dpi: data[0].dpi ,
                    servicio: $variable2
