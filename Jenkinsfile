    ...
    post {  
         ...
         success {  
             ...
             emailext body: "${currentBuild.currentResult}: Job ${env.JOB_NAME} build ${env.BUILD_NUMBER}\n More info at: ${env.BUILD_URL}",
                recipientProviders: [[$class: 'DevelopersRecipientProvider'], ['marroquin161390@unis.edu.gt'], [$class: 'RequesterRecipientProvider']],
         ...
         failure {  
             ...
             emailext body: "${currentBuild.currentResult}: Job ${env.JOB_NAME} build ${env.BUILD_NUMBER}\n More info at: ${env.BUILD_URL}",
                recipientProviders: [[$class: 'DevelopersRecipientProvider'], ['marroquin161390@unis.edu.gt'], [$class: 'RequesterRecipientProvider'], [ $class: "CulpritsRecipientProvider"]],
                subject: "Jenkins Build ${currentBuild.currentResult}: Job ${env.JOB_NAME}"
         }  
         unstable {  
